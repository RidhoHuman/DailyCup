...
// Get notifications
try {
    error_log("Notification get.php: Fetching for user_id={$userId}, limit={$limit}, offset={$offset}");
    
    $notifications = $notificationService->getByUser($userId, $limit, $offset, $unreadOnly);
    $unreadCount = $notificationService->getUnreadCount($userId);
    
    error_log("Notification get.php: Found " . count($notifications) . " notifications, {$unreadCount} unread");
} catch (Exception $e) {
