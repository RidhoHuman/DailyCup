...
try {
    ...
    $order = [
        ...
        'order_number' => $orderData['order_number'], // Add redundant for clarity
        'total' => (float)$orderData['final_amount'],
        'total_amount' => (float)$orderData['final_amount'], // Alias for consistency
        'subtotal' => (float)$orderData['total_amount'],
        'discount' => (float)$orderData['discount_amount'],
        'status' => $orderData['status'], // Real order status
        'payment_status' => $orderData['payment_status'], // Real payment status
        'paymentMethod' => $orderData['payment_method'],
        'payment_method' => $orderData['payment_method'], // Alias
