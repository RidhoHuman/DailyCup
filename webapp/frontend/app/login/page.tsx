...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Localize common backend messages to Indonesian for better UX
      let localized = errorMessage;
      if (typeof errorMessage === 'string' && errorMessage.toLowerCase().includes('invalid email or password')) {
        localized = 'Email salah atau password salah.';
      }

      setErrors({ general: localized });
    } finally {
      setIsLoading(false);
    }
  };
